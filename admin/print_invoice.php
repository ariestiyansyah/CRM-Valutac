...
<article>
  ...
  <table class="meta">
    ...
    <tr>
      ...
      <td><span><?php echo Filter::dodate("short_date", $row->duedate);?></span></td>
    </tr>
  ...
  <table class="inventory">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><span><?php echo $core->formatMoney($irow->amount);?></span></td>
      </tr>
      <?php endforeach;?>
      <?php endif;?>
      <?php if($row->tax):?>
  ...
  <table class="balance">
    <tr>
      ...
      <td><span><?php echo $core->formatMoney($row->amount_total - $row->tax);?></span></td>
    </tr>
    <tr>
