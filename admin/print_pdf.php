<?php
   ...
   * @copyright 2014
   * @version $Id: print_pdf.php, v3.00 2014-06-05 10:12:05 gewa Exp $
   */
...
<table style="padding-top:25px">
  ...
  <tr>
    ...
    <td valign="top" style="width:20%">Amount Due:<br />
      Due Date:</td>
    <td valign="top" style="width:20%"><?php echo Registry::get("Core")->formatMoney($row->amount_total - $row->amount_paid);?><br />
      <?php echo Filter::dodate("short_date", $row->duedate);?></td>
  </tr>
</table>
...
<table class="payments">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><span><?php echo Filter::dodate("short_date", $prow->created);?></span></td>
...
<div id="aside">
  ...
  <div id="footer">To make a payment, please, login to the client area at: <?php echo SITEURL;?></div>
</div>
</body>
</html>
<?php else:?>
