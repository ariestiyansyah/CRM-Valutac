<?php
   ...
   * @copyright 2014
   * @version $Id: system.php, v3.00 2014-06-05 10:12:05 gewa Exp $
   */
  if (!defined("_VALID_PHP"))
      die('Direct access to this location is not allowed.');

  if($user->userlevel == 5): print Filter::msgInfo(Lang::$word->ADMINONLY, false); return; endif;
...
<div class="wojo black icon message"><i class="icon pin"></i>
  <div class="content"><?php echo Core::langIcon();?><?php echo Lang::$word->SYS_INFO;?></div>
</div>
<div class="wojo basic block segment">
  <h2 class="wojo left floated header"><i class="information icon"></i><?php echo Lang::$word->SYS_SUB;?></h2>
  <ul class="idTabs" id="tabs">
    <li><a data-tab="#fm"><?php echo Lang::$word->SYS_CMS_INF;?></a></li>
...
<div class="wojo segment">
  <div id="fm" class="tab_content">
    <table class="wojo two column basic table">
      <thead>
        <tr>
      ...
      <tbody>
        <tr>
          ...
          <td>v<?php echo $core->crmv;?> <span id="version"> </span></td>
        </tr>
        <tr>
