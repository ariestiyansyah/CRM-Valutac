...
<?php
  ...
  $array = array(
      ...
      'return_url' => SITEURL . '/estimator.php?id=' . $row2->id . '&amp;order=ok',
      'cancel_url' => SITEURL,
      'notify_url' => SITEURL . '/gateways/' . $row->dir . '/eipn.php',
      'name_first' => $user->fname,
      'name_last' => $user->lname,
      'email_address' => $user->email,
      'm_payment_id' => $row2->id,
      'amount' => $amount,
      'item_name' => cleanOut($row2->title),
	  'item_description' => 'Payment for - ' . cleanOut($row2->title),
