<?php
   ...
   * @copyright 2013
   * @version $Id: form.tpl.php, v2.00 2013-07-20 10:12:05 gewa Exp $
   */
...
<div class="wojo basic button">
  <form action="https://<?php echo $url;?>" method="post" class="xform" id="ap_form" name="ap_form">
    ...
    <input type="hidden" name="ap_returnurl" value="<?php echo SITEURL;?>/estimator.php?id=<?php echo $row2->id;?>&amp;order=ok" />
    ...
    <input type="hidden" name="ap_itemname" value="Project Invoice - <?php echo cleanOut($row2->title);?>" />
