    ...
    <tbody>
      ...
      <tr>
        <td style="text-align: left;" valign="top">Hello <strong>[STAFF_NAME]</strong>,<br/>
          <br/>
          Your Client <b>[NAME]</b> at [COMPANY] has submitted new message. Please login to your Admin Area to view the details.</td>
      </tr>
      <tr>
        <td style="text-align: left;" valign="top"><strong>Message Summary:</strong><br>
          <br>
          <table width="100%" border="0" cellpadding="5" cellspacing="2" style="font-family: Helvetica Neue,Helvetica,Arial, sans-serif; font-size:13px;">
            <tr>
              <td width="150" style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">Message Content:</td>
              <td style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">[MSG]</td>
            </tr>
            <tr>
              <td width="150" style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">Attachmentt:</td>
