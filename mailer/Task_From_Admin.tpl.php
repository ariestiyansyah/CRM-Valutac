  ...
  <table style="font-family: Helvetica Neue,Helvetica,Arial, sans-serif; font-size:13px;background: #F4F4F4; width: 100%; border: 4px solid #bbbbbb;" cellpadding="10" cellspacing="5">
    ...
    <tr>
      <td style="text-align: left;" valign="top">Hello <strong>[STAFF_NAME]</strong>,<br/>
        <br/>
        Your Admin Manager at [SITEURL] has assigned a new task for your review. Please login to the Admin Area to view the details.</td>
    </tr>
    <tr>
      <td style="text-align: left;" valign="top"><strong>Task Summary:</strong><br>
        <br>
        <table width="100%" border="0" cellpadding="5" cellspacing="2" style="font-family: Helvetica Neue,Helvetica,Arial, sans-serif; font-size:13px;">
          ...
          <tr>
            <td style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">Task Name</td>
            <td style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">[TTITLE]</td>
          </tr>
          <tr>
