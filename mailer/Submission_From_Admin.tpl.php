  ...
  <table style="font-family: Helvetica Neue,Helvetica,Arial, sans-serif; font-size:13px;background: #F4F4F4; width: 100%; border: 4px solid #bbbbbb;" cellpadding="10" cellspacing="5">
    ...
    <tr>
      <td style="text-align: left;" valign="top">Hello <strong>[NAME]</strong>,<br/>
        <br/>
        Your Project Manager at [COMPANY] has submitted a new submission for your review. Please <a href="[SITEURL]">login to the Client Area</a> to approve or reject this submission.</td>
    </tr>
    <tr>
      <td style="text-align: left;" valign="top"><strong>Submission Summary:</strong><br>
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="2" style="font-family: Helvetica Neue,Helvetica,Arial, sans-serif; font-size:13px;">
          ...
          <tr>
            <td style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">Project Manager</td>
            <td style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">[STAFF_NAME]</td>
          </tr>
          <tr>
            <td style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">Description:</td>
