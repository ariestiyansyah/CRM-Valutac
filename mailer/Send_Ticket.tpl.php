  ...
  <table style="font-family: Helvetica Neue,Helvetica,Arial, sans-serif; font-size:13px;background: #F4F4F4; width: 100%; border: 4px solid #bbbbbb;" cellpadding="10" cellspacing="5">
      ...
      <tr>
        <td style="text-align: left;" valign="top">Hello <strong>Admin</strong>,<br/>
          <br/>
          Your Client at [COMPANY] has submitted a new ticket. Please login to the Admin Area to view this message.</td>
      </tr>
      <tr>
        <td style="text-align: left;" valign="top"><strong>Contact Summary:</strong><br>
          ...
          <table width="100%" border="0" cellpadding="5" cellspacing="2" style="font-family: Helvetica Neue,Helvetica,Arial, sans-serif; font-size:13px;">
            <tr>
              <td width="150" style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">Client Name:</td>
            ...
            <tr>
              <td style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">Ticket Priority:</td>
              <td style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">[PRIORITY]</td>
            </tr>
            <tr>
              <td style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">Ticket Subject:</td>
            ...
            <tr>
              ...
              <td style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">[MSG]</td>
            </tr>
            <tr>
              <td style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">Attachmentt:</td>
              <td style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">[ATTACHMENT]</td>
            </tr>
          </table></td>
      </tr>
      <tr>
