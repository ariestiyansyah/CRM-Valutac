    ...
    <tbody>
      ...
      <tr>
        <td style="text-align: left;" valign="top">Hello <strong>[NAME]</strong>,<br/>
          <br/>
          A new support ticket hass been open. Please login to your <a href="[SITEURL]">Client Area</a> to view the details.</td>
      </tr>
      <tr>
        <td style="text-align: left;" valign="top"><strong>Ticket Summary:</strong><br>
          ...
          <table width="100%" border="0" cellpadding="5" cellspacing="2" style="font-family: Helvetica Neue,Helvetica,Arial, sans-serif; font-size:13px;">
            ...
            <tr>
              <td width="150" style="text-align: left; background-color:#fff;border-top-width:2px; border-top-color:#ccc; border-top-style:solid;">Ticket Content:</td>
