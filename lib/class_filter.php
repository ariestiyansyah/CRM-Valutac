<?php
  ...
  final class Filter
  {
      ...
      {
          self::$showMsg = "<div class=\"wojo icon message error\"><i class=\"flag icon\"></i><i class=\"close icon\"></i><div class=\"content\"><div class=\"header\"> " . Lang::$word->INFO . "</div><p>" . $msg .
              "</p></div></div>";
          if ($fader == true)
              self::$showMsg .= "<script type=\"text/javascript\"> 
		  // <![CDATA[
      ...
      {
          if (DEBUG == true) {
              $the_error = "<div class=\"wojo message error\">";
